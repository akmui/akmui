...
<div class="form-group">
	...
	<textarea class="form-control" name="description" id="form-description" placeholder="본문을 적어주세요" rows="8" cols="40"></textarea>
</div>

		<input type="hidden" role="uploadcare-uploader" />
		<input type="submit" name="botton" class='btn btn-default btn-lg'>
	</form>
